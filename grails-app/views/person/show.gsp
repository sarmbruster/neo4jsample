...
<div class="body">
  ...
  <div class="dialog">
    <table>
      ...
      <tr class="prop">
        <td valign="top" class="name"><g:message code="person.friends.label" default="Friends"/></td>

        <td valign="top" style="text-align: left;" class="value">
          <ul>
            <g:each in="${personInstance.friends}" var="f">
              <li><g:link controller="person" action="show" id="${f.id}">${f?.encodeAsHTML()}</g:link></li>
            </g:each>
          </ul>
        </td>

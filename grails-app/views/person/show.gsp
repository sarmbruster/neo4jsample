	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.friends}">
				<li class="fieldcontain">
					<span id="friends-label" class="property-label"><g:message code="person.friends.label" default="Friends" /></span>
					
						<g:each in="${personInstance.friends}" var="f">
						<span class="property-value" aria-labelledby="friends-label"><g:link controller="person" action="show" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
